...
class Network(object):
    ...
    def __ilshift__(self, other):
        ...
        if isinstance(self, TD3):
            self._DDPG__actor.set_weights(other._DDPG__actor.get_weights())
            self._DDPG__critic_1.set_weights(other._DDPG__critic_1.get_weights())
            self._DDPG__critic_2.set_weights(other._DDPG__critic_2.get_weights())
...
class TD3(Network):
    ...
    def __init__(self, states, actions=1, hiddens=[25, 25], load_agent=False, name='generic', path=None,
                  load_critic=True):
        """Creates a new DDPG network.
        ...
        # Creating a new agent
          ...
          '''
          # Saving model
          self.save_model(name, path=path)
    ...
    def __ilshift__(self, other):
        ...
        self._TD3__critic_1.set_weights(other._TD3__critic_2.get_weights())
